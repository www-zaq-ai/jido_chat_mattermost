defmodule Jido.Chat.Mattermost.TypingOptions do
  @moduledoc "Options for sending a typing indicator to Mattermost."
  ...
  @doc "Builds typing options from a keyword list."
  @spec new(keyword()) :: t()
  def new(opts \\ []) do
    %__MODULE__{
      token: opts[:token],
  ...
  @doc "Extracts transport options for typing requests."
